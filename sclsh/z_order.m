% random experiments to evaluate average distance(or diff) of NNs along z-order
...
for d = [2:2:10]
    ...
    for i=1:size(I,2)
        ...
        oall = zorder_encode(svq);	% all orders: [d,n+nq]
    ...
    recall_zorder=[recall_zorder;avg_diff];
end;